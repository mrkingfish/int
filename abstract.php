...
abstract class BaseMoviesCache {
    ...
    public function set($keyword, $value = "", $time = 0, $option = array() ) {
        ...
        /*
         * Temporary disabled moviesCache::$disabled = true
         * Khoa. B
         */
        if(moviesCache::$disabled === true) {
            return false;
        }
        $object = array(
            "value" => $value,
    ...
    /*
    * Other Functions Built-int for moviesCache since 1.3
    */
    ...
    protected function backup() {
        return moviesCache(moviesCache::$config['fallback']);
    }
    ...
    public function getPath($create_path = false) {
        return moviesCache::getPath($create_path,$this->config);
    }
...
*/
    ...
    protected function isPHPModule() {
       return moviesCache::isPHPModule();
    }
    ...
    public function systemInfo() {
        ...
        $example = new moviescache_example($this->config);
    ...
    protected function isExistingDriver($class) {
        if(@file_exists(dirname(__FILE__)."/drivers/".$class.".php")) {
            ...
            if(class_exists("moviescache_".$class)) {
                return true;
            }
        }
    ...
    protected function __setChmodAuto() {
        return moviesCache::__setChmodAuto($this->config);
    }
